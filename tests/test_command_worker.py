...
from client.command_controller import (
    ...
    # TODO: captureBedReference fjernet - må implementeres på nytt
    # captureBedReference,
)
...
# TODO: Test fjernet - må implementeres på nytt når captureBedReference er reimplementert
#
# Denne testen verifiserer at captureBedReference funksjonen:
# - Bruker bed reference job (.3mf fil)
# - Kobler til printer via MQTT
# - Starter kamera
# - Tar riktig antall snapshots
# - Stopper print og kamera etter capture
#
# Test må reimplementeres når captureBedReference funksjonen er klar
#
# def testCaptureBedReferenceUsesBedReferenceJob(
#     monkeypatch: pytest.MonkeyPatch, tmp_path: Path
# ) -> None:
#     # Test implementasjon her...
#     pass
